...
class PDF(fpdf.FPDF):
    ...
    def _font_init(self):
        self.add_font('GHGuardianHeadline-Light', '',        Path('fonts/GHGuardianHeadline-Light.ttf', uni=True))
        self.add_font('GHGuardianHeadline-LightItalic', '',  Path('fonts/GHGuardianHeadline-LightItalic.ttf', uni=True))
        self.add_font('GHGuardianHeadline-Medium', '',       Path('fonts/GHGuardianHeadline-Medium.ttf', uni=True))
        self.add_font('GHGuardianHeadline-MediumItalic', '', Path('fonts/GHGuardianHeadline-MediumItalic.ttf', uni=True))
        self.add_font('GHGuardianHeadline-Bold', '',         Path('fonts/GHGuardianHeadline-Bold.ttf', uni=True))
        self.add_font('GHGuardianHeadline-BoldItalic', '',   Path('fonts/GHGuardianHeadline-BoldItalic.ttf', uni=True))
        self.add_font('GuardianTextSans-Regular', '',        Path('fonts/GuardianTextSans-Regular.ttf', uni=True))
        self.add_font('GuardianTextSans-Regular', '',        Path('fonts/GuardianTextSans-Regular.ttf', uni=True))
        self.add_font('GuardianTextSans-RegularItalic', '',  Path('fonts/GuardianTextSans-RegularItalic.ttf', uni=True))
        self.add_font('GuardianTextSans-RegularItalic', '',  Path('fonts/GuardianTextSans-RegularItalic.ttf', uni=True))
        self.add_font('GuardianTextSans-Bold', '',           Path('fonts/GuardianTextSans-Bold.ttf', uni=True))
        self.add_font('GuardianTextSans-Bold', '',           Path('fonts/GuardianTextSans-Bold.ttf', uni=True))
        self.add_font('GuardianTextSans-BoldItalic', '',     Path('fonts/GuardianTextSans-BoldItalic.ttf', uni=True))
        self.add_font('GuardianTextSans-BoldItalic', '',     Path('fonts/GuardianTextSans-BoldItalic.ttf', uni=True))
