...
class PDF(fpdf.FPDF):
    ...
    def _font_init(self):
        self.add_font('GHGuardianHeadline-Light', '',        str(Path('fonts/GHGuardianHeadline-Light.ttf', uni=True)))
        self.add_font('GHGuardianHeadline-LightItalic', '',  str(Path('fonts/GHGuardianHeadline-LightItalic.ttf', uni=True)))
        self.add_font('GHGuardianHeadline-Medium', '',       str(Path('fonts/GHGuardianHeadline-Medium.ttf', uni=True)))
        self.add_font('GHGuardianHeadline-MediumItalic', '', str(Path('fonts/GHGuardianHeadline-MediumItalic.ttf', uni=True)))
        self.add_font('GHGuardianHeadline-Bold', '',         str(Path('fonts/GHGuardianHeadline-Bold.ttf', uni=True)))
        self.add_font('GHGuardianHeadline-BoldItalic', '',   str(Path('fonts/GHGuardianHeadline-BoldItalic.ttf', uni=True)))
        self.add_font('GuardianTextSans-Regular', '',        str(Path('fonts/GuardianTextSans-Regular.ttf', uni=True)))
        self.add_font('GuardianTextSans-Regular', '',        str(Path('fonts/GuardianTextSans-Regular.ttf', uni=True)))
        self.add_font('GuardianTextSans-RegularItalic', '',  str(Path('fonts/GuardianTextSans-RegularItalic.ttf', uni=True)))
        self.add_font('GuardianTextSans-RegularItalic', '',  str(Path('fonts/GuardianTextSans-RegularItalic.ttf', uni=True)))
        self.add_font('GuardianTextSans-Bold', '',           str(Path('fonts/GuardianTextSans-Bold.ttf', uni=True)))
        self.add_font('GuardianTextSans-Bold', '',           str(Path('fonts/GuardianTextSans-Bold.ttf', uni=True)))
        self.add_font('GuardianTextSans-BoldItalic', '',     str(Path('fonts/GuardianTextSans-BoldItalic.ttf', uni=True)))
        self.add_font('GuardianTextSans-BoldItalic', '',     str(Path('fonts/GuardianTextSans-BoldItalic.ttf', uni=True)))
