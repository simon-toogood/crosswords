...
class PDF(fpdf.FPDF):
    ...
    def _font_init(self):
        self.add_font('GHGuardianHeadline-Light', '',        'fonts/GHGuardianHeadline-Light.ttf', uni=True)
        self.add_font('GHGuardianHeadline-LightItalic', '',  'fonts/GHGuardianHeadline-LightItalic.ttf', uni=True)
        self.add_font('GHGuardianHeadline-Medium', '',       'fonts/GHGuardianHeadline-Medium.ttf', uni=True)
        self.add_font('GHGuardianHeadline-MediumItalic', '', 'fonts/GHGuardianHeadline-MediumItalic.ttf', uni=True)
        self.add_font('GHGuardianHeadline-Bold', '',         'fonts/GHGuardianHeadline-Bold.ttf', uni=True)
        self.add_font('GHGuardianHeadline-BoldItalic', '',   'fonts/GHGuardianHeadline-BoldItalic.ttf', uni=True)
        self.add_font('GuardianTextSans-Regular', '',        'fonts/GuardianTextSans-Regular.ttf', uni=True)
        self.add_font('GuardianTextSans-Regular', '',        'fonts/GuardianTextSans-Regular.ttf', uni=True)
        self.add_font('GuardianTextSans-RegularItalic', '',  'fonts/GuardianTextSans-RegularItalic.ttf', uni=True)
        self.add_font('GuardianTextSans-RegularItalic', '',  'fonts/GuardianTextSans-RegularItalic.ttf', uni=True)
        self.add_font('GuardianTextSans-Bold', '',           'fonts/GuardianTextSans-Bold.ttf', uni=True)
        self.add_font('GuardianTextSans-Bold', '',           'fonts/GuardianTextSans-Bold.ttf', uni=True)
        self.add_font('GuardianTextSans-BoldItalic', '',     'fonts/GuardianTextSans-BoldItalic.ttf', uni=True)
        self.add_font('GuardianTextSans-BoldItalic', '',     'fonts/GuardianTextSans-BoldItalic.ttf', uni=True)
